...
export default {
  ...
  computed:{
    ...mapState('example2',['pagination','tableData','filters','total']),
    ...mapState({
      loading: state => {
        return state['@@loading'].effects['example2/query']
      }
    })
  },
  methods:{
    ...mapActions('example2',['handleCurrentChange','query','getters','handleSizeChange','otherAction','setFilter']),
